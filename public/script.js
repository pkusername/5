document.addEventListener("DOMContentLoaded", function () {
            ...
            .then(bookings => {
                ...
                bookings.forEach(booking => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${booking.otherFees || 0}</td>
                        <td>${booking.deposit || 0}</td>
                        <td>${booking.receivable || 0}</td>
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        const formData = {
            ...
            price: document.getElementById('editPrice').value || '',  // 直接获取字符串值，不做任何转换
            ...
            receivable: parseFloat(document.getElementById('editReceivable').value) || 0,
